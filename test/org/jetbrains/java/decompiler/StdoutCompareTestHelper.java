...
/**
 * Runs all main() methods in StdOutTest package, puts stdout output into file.
 * Decompiles all stdout test.
 * Runs all main() of decompiled verions and compares.
 * 
 * @author dw
 *
 */
...
public class StdoutCompareTestHelper {
  ...
  private static DecompilerTestFixture createDecompiler(String externalTempDir, boolean renaming) throws IOException {
...
private static void runAllMain(List<String> classNames, String outputDir) throws Exception {
  ...
  public static void main(String[] args) {
      ...
      try {
          ...
          if (args[0].equals("run")) {
          ...
          else if (args[0].startsWith("decompile")) {
              boolean renaming;
              if (args[0].equals("decompile")) {
                  renaming = false;
              }
              else if (args[0].equals("decompile-renaming")) {
                  renaming = true;
              }
              else {
              ...
              DecompilerTestFixture fixture = createDecompiler(args[2], renaming);
